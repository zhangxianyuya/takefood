    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 89%" class="table">
                <el-table-column prop="shop_name" label="店铺名称" width="130" align="center">
                </el-table-column>
                <el-table-column prop="price" label="产品单价" width="130" align="center">
                </el-table-column>
                <el-table-column prop="sale" label="月销量" width="130" align="center">
                </el-table-column>
                <el-table-column prop="hp_num" label="好评数" width="130" align="center">
                </el-table-column>
                <el-table-column prop="cp_num" label="差评数" width="130" align="center">
                </el-table-column>
                <el-table-column prop="shop_tel" label="店铺电话" width="130" align="center">
                </el-table-column>
            ...
            <el-dialog title="添加店铺" :visible.sync="dia_add" width="30%">
                <el-form ref="add_form" :model="add_form" label-width="100px" :rules="add_form_rules">
                    ...
                    <el-form-item label="店铺电话：" prop="shop_tel">
                        <el-input v-model="add_form.shop_tel"></el-input>
                    </el-form-item>
            ...
            <el-dialog title="修改店铺" :visible.sync="dia_chg" width="30%">
                <el-form ref="form" :model="chg_form" label-width="100px">
                    ...
                    <el-form-item label="店铺电话：">
                        <el-input v-model="chg_form.shop_tel"></el-input>
                    </el-form-item>
    ...
    data() {
        return {
            ...
            add_form_rules: {
                ...
                shop_tel: [{ required: true, message: '必填项', trigger: 'blur' }]
